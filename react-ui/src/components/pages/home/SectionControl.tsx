      ...
      <Grid>
        ...
        <Content className='test'>
          <ContentBlock margin={false}>
            ...
            <p>
              You have full control over your secrets at any time. You can view recent activity or change the settings
              of your generated
          ...
          <ContentBlock margin={true}>
            ...
            <p>
              You want an extra layer of security? Protect your secrets with a password. That way even if an
              unauthorized person obtains the
          ...
          <ContentBlock margin={true}>
            ...
            <p>
              You can delete your messages and links at any time. This will completely remove the content from our
              database - no traces left
            </p>
          </ContentBlock>
        </Content>
      </Grid>
