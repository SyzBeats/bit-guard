			...
			<Grid>
				<Content className='test'>
					<ContentBlock margin={false}>
						...
						<p>In your dashboard, simply create a new message. The content of this message will be encrypted
							and stored
							in our database.</p>
					</ContentBlock>
					...
					<ContentBlock margin={true}>
						...
						<p>
							To give people access to your secrets, you will have to generate a Link for your Message.
							This link will
							point to the
					...
					<ContentBlock margin={true}>
						...
						<p>
							You choose who can access your Message. You can share the link with anyone you want.
							Friends, family,
